    ...
    <section className="w-full px-4 md:px-6 lg:px-8 mt-6">
      <div className="container mx-auto max-w-7xl pt-8 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden h-[300px] md:h-[400px] lg:h-[460px] group shadow-sm flex flex-col justify-end">
            <Image
            ...
            {sideNews.map((news, idx) => (
              ...
              >
                ...
                <div className="flex flex-col">
                  <h4 className="text-heading font-bold text-[15px] leading-snug mb-2 group-hover:text-[#02B290] transition-colors">
                    {news.title}
                  </h4>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
          <button className="lg:col-span-2 w-full py-3.5 bg-[#02B290] text-white font-semibold rounded-md hover:bg-[#029579] transition-colors shadow-[0_4px_6px_-4px_rgba(20,113,25,0.25),0_10px_15px_-3px_rgba(20,113,25,0.25)] flex items-center justify-center gap-2 cursor-pointer">
            <span className="material-icons text-lg">add</span>
            View All CDS Projects
          </button>
          <button className="w-full text-center py-3.5 rounded-md bg-linear-to-r from-[#02B290] to-[#0FDF46] text-white shadow-[0_4px_6px_-4px_rgba(20,113,25,0.25),0_10px_15px_-3px_rgba(20,113,25,0.25)] font-semibold flex items-center justify-center gap-2 cursor-pointer bg-size-[200%_200%] bg-left hover:bg-right transition-all duration-500">
            <span className="material-icons text-lg">add</span>
            Propose New Project
          </button>
        </div>

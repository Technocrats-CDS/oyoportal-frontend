	...
	return (
		<div className="flex flex-col gap-4 w-full">
			...
			<div className="flex justify-center items-center gap-2 mt-8 pb-18">
				...
				<button
					type="button"
					className="w-10 h-10 rounded-lg bg-brand text-white font-bold"
				>
					1
				</button>
				<button
					type="button"
					className="w-10 h-10 rounded-lg text-slate-600 border border-[#E2E8F0] font-bold"
				>
					2
				</button>
				<button
			...
			<div className="flex flex-col gap-3 w-full">
				<div className="flex flex-col gap-1">
					...
					<div className="flex gap-1 items-center">
						...
						{data.isVerified && (
							<BadgeCheck className="text-blue-500 fill-blue-500" size={14} />
						)}
					</div>
				</div>
				...
				<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-2">
					...
					<div className="flex items-center gap-5 w-full sm:w-auto">
						...
						<Button className="bg-brand hover:bg-brand-600 text-white font-bold h-10 px-6 rounded-xl">
							Apply Now
						</Button>
					</div>
				</div>

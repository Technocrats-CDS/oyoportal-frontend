    ...
    <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden flex flex-col group hover:shadow-md transition-shadow">
      ...
      <div className="p-5 flex-1 flex flex-col">
        ...
        <div className="flex gap-3 mt-auto">
          <button className="flex-1 py-3 bg-slate-100 hover:bg-slate-200 text-slate-800 font-semibold rounded-md transition-colors text-sm">
            View
          </button>
          <button className="flex-1 flex items-center justify-center gap-2 bg-[#00A97E] text-white py-2.5 px-4 rounded-md font-semibold hover:bg-[#00A97D]/90 transition-colors text-sm">
            <svg
              width="10"
              height="12"
              viewBox="0 0 14 18"

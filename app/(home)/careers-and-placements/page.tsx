            ...
            <div className="flex flex-col gap-6 w-full">
              <div className="flex flex-col md:flex-row gap-3 w-full">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full h-[50px] bg-white border border-slate-200 rounded-xl pl-12 pr-4 text-sm text-gray-800 placeholder:text-slate-400 outline-none focus:border-[#02B290] focus:ring-2 focus:ring-[#02B290]/20 transition"
                  />
                </div>

                <div className="flex gap-3 shrink-0">
                  <Select defaultValue="institutions">
                    <SelectTrigger className="!h-[50px] bg-white border border-slate-200 rounded-xl px-5 text-sm font-medium text-gray-800 outline-none focus:border-[#02B290] focus:ring-2 focus:ring-[#02B290]/20 min-w-[170px]">
              ...
              <div className="flex justify-between text-sm">
                ...
                <div className="flex gap-2">
                  <div className="bg-[#FFFFFF] h-8 w-8 border-1 border-[#E2E8F0] p-1 rounded-sm">
                    <span className="material-icons-outlined h-2.5 w-2.5 font-bold">
                      grid_view
                    </span>
                  </div>
                  <div className="bg-[#02B280] h-8 w-8 border-1 border-[#E2E8F0] p-1 rounded-sm">
